...
def select_name_and_series_subgenres_of_authors
  return "SELECT Authors.name, Subgenres.name FROM Authors JOIN Series ON Series.author_id = Author.id INNER JOIN Subgenres ON Subgenres.id = Series.subgenre_id;"
end
